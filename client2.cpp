...
{	
	...
	BSTree<Student,int,Greater> tree;
   ...
   BSTree<Student,int,Greater> bst1;
   bst1=std::move(tree);
   bst1.print(INORDER);
   BSTree<Student,int,Greater> bst3(std::move(bst1));
   bst3.print(INORDER);
   BSTree<Student,int,Greater> bst2;
   bst2=bst3;
   bst2.print(INORDER);
   BSTree<Student,int,Greater> bst4(bst2);
   bst4.print(INORDER);
    return 0;
